<html>
<head>Question 6b<br>Query: select SLName,SFName from Suppliers where CompanyName= 'Australia Cricket'<br><br></head>
<title></title>
</head>
<body>
<center>
...
$query = "SELECT SLName,SFName from Suppliers where CompanyName = 'Australia Cricket'";
$msc = microtime(true);
...
$exesql= " CREATE INDEX SecondaryIndex ON Suppliers(CompanyName);";

$exeresult=mysql_query($exesql);
if($exeresult)
	{
		echo "<br><h2>Create Index Named SecondaryIndex on secondary key Succeed</h2></br></br>";
	}
	else
	{
	 	echo mysql_error()."</br>";
...
$querytwo = "SELECT SLName,SFName from Suppliers USE INDEX(SecondaryIndex) where CompanyName= 'Australia Cricket'";
